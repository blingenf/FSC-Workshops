...
class aliceThread(threading.Thread):
    ...
    def run(self):
        ...
        while self.running:
            ...
            self.sleep(1)
            self.browser.find_element_by_id("username").send_keys("Alice")
            self.sleep(1)
            self.browser.find_element_by_id("password").send_keys("<alice-password>")
            self.sleep(1)
            ...
            self.sleep(2)
            self.browser.find_element_by_id("show_img").click()
            self.sleep(2)
